...
export const Card = React.memo(
  ({
    ...
    <div
      ...
      className={cn(
        "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden w-full aspect-[32/7] md:h-[300px] transition-all duration-300 ease-out flex items-center justify-center",
